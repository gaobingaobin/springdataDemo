...
(function ($, undefined) {
    ...
    Wizard.prototype = {
        constructor: Wizard, setState: function () {
            ...
            var prevSelector = ".wizard-steps > li:lt(" + (this.currentStep - 1) + ")";
            var $prevSteps = this.$element.find(prevSelector);
            $prevSteps.addClass("complete");
            $prevSteps.find("span.badge").addClass("badge-success");
            var currentSelector = ".wizard-steps > li:eq(" + (this.currentStep - 1) + ")";
    ...
    $.fn.wizard.defaults = {selectedItem: {step: 1}};
