        ...
        initSlider: function (c, d) {
            ...
            if (this.$input.is(":visible")) {
                ...
                if (!this.nativeUI) {
                    ...
                    var d = b.extend(this.options.slider, {
                        value: g, slide: function (h, i) {
