            ...
            case"submit":
                ...
                if (b.isEmptyObject(k)) {
                    ...
                    if (c.length === 1) {
                        ...
                        var g = {
                            name: d.options.name || "",
                            value: d.input.value2submit(d.value),
                            pk: (typeof d.options.pk === "function") ? d.options.pk.call(d.options.scope) : d.options.pk
                        };
    ...
    b.extend(a.prototype, {
        render: function () {
            ...
            if (typeof g === "string") {
                ...
                var c = b.extend({
                    url: g, type: "get", cache: false, dataType: "json", success: b.proxy(function (e) {
                        if (d) {
                            d.loading = false
                        }
...
(function (b) {
    ...
    b.extend(b.fn.editableform.Constructor.prototype, {
        initTemplate: function () {
            this.$form = b(b.fn.editableform.template);
