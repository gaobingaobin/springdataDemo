"ace" in window || (window.ace = {}), "helper" in window.ace || (window.ace.helper = {}), "options" in window.ace || (window.ace.options = {}), "vars" in window.ace || (window.ace.vars = {
    ...
    var i = {
        ...
        sidebar_hoverable: {sub_scroll: !1},
        widget_boxes: null,
        ...
        e.event.special.ace_drag = {
            setup: function () {
                ...
                n.on(a, function (a) {
                    ...
                    var o, l = a.originalEvent.touches ? a.originalEvent.touches[0] : a, c = {
    ...
    function t(a, t, n) {
        ...
        if (e(document).trigger(r = e.Event("ajaxloadstart"), {url: a, hash: t}), !r.isDefaultPrevented()) {
            ...
            p.css({top: f.top, left: f.left}), e.ajax({url: a}).complete(function () {
                ...
                }, 10), d && s(l, v), n || e("html,body").animate({scrollTop: 0}, 250), e(document).trigger("ajaxloadcomplete", {
                    url: a,
                    hash: t
                })
            })
        ...
        if (l && c) {
            var d, u, h = null, v = null, p = null, f = null, g = null, m = !1, b = !1, w = a.scroll_to_active || !1, _ = a.include_shortcuts || !1, y = a.include_toggle || !1, C = a.smooth_scroll || !1, x = a.outside || !1, k = "getComputedStyle" in window ? function () {
                ...
                available_height: function () {
                    ...
                    if (!b && T) {
                        s.wrap('<div style="position: relative;" />'), s.after("<div><div></div></div>"), s.wrap('<div class="nav-wrap" />'), y || n.css({"z-index": 1}), _ || r.css({"z-index": 99}), h = s.parent().next().ace_scroll({
                    ...
                    m = !0, e && (p.css({
                        height: u,
                        width: 8
                    }), h.prev().css({"max-height": d}), g.update({size: d}).enable().reset()), e && g.is_active() ? i.addClass("sidebar-scroll") : m && H.disable()
                }, disable: function () {
                    m = !1, h && (h.css({height: "", "max-height": ""}), p.css({
                        height: "",
                        width: ""
                    }), h.prev().css({"max-height": ""}), g.disable()), parseInt(c.style.top) < 0 && C && ace.vars.transition ? s.one("transitionend.trans webkitTransitionEnd.trans mozTransitionEnd.trans oTransitionEnd.trans", function () {
    ...
    try {
        e("#nav-search-input").bs_typeahead({
            source: ace.vars.US_STATES, updater: function (a) {
